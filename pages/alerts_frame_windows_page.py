...
from locators.alerts_frame_windows_page_locators import BrowserWindowsPageLocators, AlertsPageLocators, \
    FramePageLocators, NestedFramesPageLocators, ModalDialogPageLocators
...
class BrowserWindowsPage(BasePage):
    ...
    def check_opened_tab(self):
        ...
        text_title = self.element_is_present(self.locators.NEW_TITLE).text
        return text_title
...
class AlertsPage(BasePage):
    ...
    def check_alert_appear_in_5_sec(self):
    ...
    def check_prompt_alert(self):
        ...
        alert_window.accept()
        text_result = self.element_is_present(self.locators.PROMPT_RESULT)
