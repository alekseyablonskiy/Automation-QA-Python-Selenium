...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.element_is_visible(self.locators.SUBJECT).send_keys('Computer Science')
        self.element_is_visible(self.locators.SUBJECT).send_keys(Keys.RETURN)
        self.element_is_visible(self.locators.HOBBIES).click()
        self.element_is_present(self.locators.FILE_INPUT).send_keys(path_to_file.generate_path_upload('picture.jpeg'))
        self.element_is_visible(self.locators.CURRENT_ADDRESS).send_keys(person.current_address)
        self.element_is_visible(self.locators.SELECT_STASTE).click()
